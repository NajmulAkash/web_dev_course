  ...
  return (
    <div className='bg-gray-300 h-screen w-screen  flex'>
      ...
      <div className=' w-80 bg-slate-100 flex flex-col my-40 h-80 py-2 mr-20 px-7 rounded-lg'>
        <input  type="text" name="" className='rounded-md my3 py-2 px-5 my-2 hover:outline-red-300' placeholder='Enter your Name' />
        <input  type="text" name="" className='rounded-md my-3 py-2 px-5 hover:outline-red-300' placeholder='Password' />
