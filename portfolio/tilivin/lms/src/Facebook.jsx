...
function Facebook() {
  return (
    <div className='bg-gray-300 h-screen w-screen  flex lg:bg-red-600 xl:bg-green-600 md:bg-yellow-600 sm:bg-pink-900'>
      ...
      <div className=' w-80 bg-slate-100 flex flex-col my-40 h-80 py-2 mr-20 px-7 rounded-lg lg:mr-48 md:mr-40'>
        ...
        <button className='bg-green-600 w-fit py-2 px-3 rounded-md my-3 mx-10 text-white lg:text-sm lg:w-60 lg:mx-3 md:w-60 md:mx-4'>Create New Accound</button>
